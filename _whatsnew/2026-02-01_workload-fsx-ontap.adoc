...
link:https://docs.netapp.com/us-en/workload-fsx-ontap/create-s3-access-points.html[Create and attach an S3 access point for a volume in NetApp Workload Factory]
