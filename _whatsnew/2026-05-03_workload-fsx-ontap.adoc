...
After analysis, you can download a PDF report of the well-architected status of your FSx for ONTAP file systems for your records or to share with your teams. link:https://docs.netapp.com/us-en/workload-fsx-ontap/improve-configurations.html[View the well-architected status of your FSx for ONTAP file systems in NetApp Workload Factory.]